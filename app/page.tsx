      ...
      <main className="grid-bg wrapper p-10 flex flex-col gap-10 w-full items-center justify-center">
        <section ref={sectionProjects} className="w-full lg:w-5/6">
          <div className="my-5 relative">
            <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-6 bg-linear-to-r from-black to-90% md:to-70% to-black/0 rounded-full" />
            <div className="relative z-10 flex flex-row items-center gap-5 px-5">
              <svg
